$(document).ready(function(){
	var l_team = false, r_team = false, sum_of_bet = 0, coef, l_team_name, r_team_name;
	l_team_name = $('.l_team_name a').html();
	r_team_name = $('.r_team_name a').html();
	$('#l_team_coef').click(function(){
